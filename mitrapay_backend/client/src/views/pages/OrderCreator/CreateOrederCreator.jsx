     ...
     <div>
          ...
          <div className="bg-white rounded shadow-sm mb-3">
            <header className="d-flex align-items-center justify-content-between px-3 py-3 border-bottom">
              ...
              <h1 className="h5 fw-bold flex-grow-1 ms-2 mb-0 text-dark">Create Order Creators</h1>
              ...
              <form className="bg-white px-5 py-4 rounded border shadow-sm">
                <div className="col-12 py-4">
                  ...
                  <p className="form-text-xs mb-0 text-muted">
                    This is info about the gaming website. You can share the redirect URL with the
                    developer to forward payment requests.
                  </p>
                </div>
                ...
                { id: 'password', label: 'Password', type: 'password', value: '*****' },
                  ...
                  <div className="col-12 pt-4">
                    ...
                    <div className="row g-3">
                     {['Status', 'View Dashboard', 'View Payin', 'View Pay Out', 'Create Manual Pay In'
                      ].map((label, idx) => (
...
export default CreateOrderCreator
